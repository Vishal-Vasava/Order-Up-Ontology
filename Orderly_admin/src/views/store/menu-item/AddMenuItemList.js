...
const AddMenuItemList = ({ open, handleModal }) => {
  // ** State
  ...
  return (
    ...
    >
      <ModalHeader
        ...
        tag="div"
      >
        <h5 className="modal-title">Trip Create</h5>
      </ModalHeader>
...
export default AddMenuItemList;
