...
import { ActivityListColumns, ProductsListColumns } from "../../data";
import {
  ChevronDown,
  Share,
  Printer,
...
const Listing = () => {
  ...
  const handleFilter = (e) => {
    ...
    if (value.length) {
      updatedData = activities.filter((item) => {
        ...
        item._producer.name.toString().toLowerCase().startsWith(value.toLowerCase()) ||
        
          

          item.name.toLowerCase().startsWith(value.toLowerCase()) || 
          (item.visible == true ? "Active" : "Inactive").toLowerCase().startsWith(value.toLowerCase()) || 
          (item.deleted == true ? "Yes" : "No").toLowerCase().startsWith(value.toLowerCase()) || 
        ...
        const includes =
          ...
          item.desc.toString().toLowerCase().includes(value.toLowerCase()) ||
          item.price.toString().toLowerCase().includes(value.toLowerCase()) ||
          item.qty.toString().toLowerCase().includes(value.toLowerCase()) ||
          item.qty.toString().toLowerCase().includes(value.toLowerCase()) ||
          (item.visible == true ? "Active" : "Inactive").toLowerCase().includes(value.toLowerCase()) ||
          (item.deleted == true ? "Yes" : "No").toLowerCase().includes(value.toLowerCase()) ||
          item._producer.name.toString().toLowerCase().includes(value.toLowerCase()) 
  ...
  const getRecord = () => {
    axios
      .get("/admin/inventory/view", { headers: { Authorization: `Bearer ${token}` } })
      .then((response) => {
