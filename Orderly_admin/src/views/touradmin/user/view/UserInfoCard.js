    ...
    <Fragment>
      <Card>
        <CardBody>
          ...
          <div className="d-flex justify-content-around my-1 pt-35">
          ...
          <div className="info-container">
            {selectedUser !== null ? (
              <ul className="list-unstyled">
                <li className="mb-75">
                  ...
                  <span>
                    ...
                    selectedUser.first_name != "null"
                      ? selectedUser.first_name
                      : ""}{" "}
                    {selectedUser.last_name && selectedUser.last_name != "null"
                ...
                <li className="mb-75">
                  <span className="fw-bolder me-25">Phone No:</span>
                  <span className="float-right">{selectedUser.phone}</span>
                </li>
                <li className="mb-75">
                  <span className="fw-bolder me-25">Point of Origin:</span>
                  <span className="float-right">
                    {selectedUser.point_of_origin}
                  </span>
                </li>
                {/* <li className="mb-75">
