      ...
      <Card className="plan-card border-primary">
        <CardBody>
          <div className="d-flex justify-content-between align-items-start">
            <Badge color="light-primary">Identity</Badge>
          </div>
          ...
          <span className="fw-bolder me-25">Identity No: </span>
          <span>{selectedUser.identity_document_no}</span>
          <br />
          {/* <div className="d-flex align-items-center justify-content-center">
            <img
              ...
              src={
                ...
                'https://upload.wikimedia.org/wikipedia/commons/c/c3/Passport-USA-1.jpg'
              }
            />
          </div> */}
        </CardBody>
