...
const RevenueReport = (props) => {
  ...
  const [data, setData] = useState({
    month:
      stateCnt && stateCnt.last7DayDiscount
        ? stateCnt.last7DayDiscount.month
        : [],
    revenue:
      stateCnt && stateCnt.last7DayDiscount
        ? stateCnt.last7DayDiscount.revenue
        : [],
    totalRevenu:
      stateCnt && stateCnt.last7DayDiscount
        ? stateCnt.last7DayDiscount.totalRevenu
        : 0,
    totalOrder:
      stateCnt && stateCnt.last7DayDiscount
        ? stateCnt.last7DayDiscount.totalOrder
        : 0,
  });
      ...
      <Row className="mx-0">
        <Col className="revenue-report-wrapper" md="8" xs="12">
          <div className="d-sm-flex justify-content-between align-items-center mb-3">
            <CardTitle className="mb-50 mb-sm-0">Discount Report</CardTitle>
