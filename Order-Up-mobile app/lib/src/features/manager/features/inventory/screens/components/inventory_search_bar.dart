...
class InventorySearchBar extends StatefulWidget {
  ...
  @override
  _InventorySearchBarState createState() => _InventorySearchBarState();
}
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<InventoryCubit, InventoryState>(
      buildWhen: (_, newState) {
        return newState is InventoryLoadedState ||
            newState is InventoryLoadingState;
      },
                          ...
                          return AnimatedOpacity(
                            ...
                            child: IconButton(
                              onPressed: () {
                                ...
                                context.read<InventoryCubit>().searchInventory(
                                      searchText: '',
                                    );
                              },
                              icon: const Icon(
