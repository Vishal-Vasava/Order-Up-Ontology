...
class NewChoiceScreen extends StatelessWidget {
  const NewChoiceScreen({super.key});
          ...
          children: [
            ...
            Center(
              child: Column(
                ...
                children: [
                  Text(
                    'New store or delivery user to our digital platform? ',
                  ...
                  InkWell(
                    onTap: () async {
                      final Uri params = Uri(
                        scheme: 'mailto',
                        path: 'orderupadmin@orderlyinc.com',
                        query:
                            'subject=New User&body=App Version ${Config.appVersion}',
                      );
                      await url_launcher.launchUrl(params);
                    },
                    child: Text(
                      'Email : orderupadmin@orderlyinc.com',
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
